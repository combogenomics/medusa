...
public class Scaffolder {
	...
	private void runOnTerminal(String[] args) throws Exception {
		...
		opts.addOption(output);
                ...
                Option fromNetwork = OptionBuilder
                                .withValueSeparator()
                                .withDescription(
                                                   "OPTIONAL PARAMETER; The option *-n* allows to skip the first steps of the pipeline, using as input a scaffolding network. This should be named 'network'")
                                .create("n");
		opts.addOption(fromNetwork);
